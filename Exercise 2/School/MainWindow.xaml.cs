...
namespace School
{
    ...
    public partial class MainWindow : Window
    {
        ...
        // When the user presses a key, determine whether to add a new student to a class, 
        ...
        private void studentsList_KeyDown(object sender, KeyEventArgs e)
        {
            switch (e.Key)
            {
                ...
                case Key.Insert:
                    ...
                    sf = new StudentForm();
                    // Exercise 2: Task 2b: Set the title of the form to indicate which class the student will be added to 
                    ...
                    if(sf.ShowDialog().Value)
                    {
                        // Exercise 2: Task 3b: When the user closes the form, 
                        // retrieve the details of the student from the form and use them to create a new Student object
